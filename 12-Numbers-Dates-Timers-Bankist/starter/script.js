...
// Parsing
console.log(Number.parseInt('30px', 10)); // second input is base system (2, 10, etc.)
console.log(Number.parseInt('e30', 10)); // Must start with number or white space

console.log(Number.parseInt('2.5rem  '));
console.log(Number.parseFloat('   2.5rem  '));

// console.log(parseFloat('   2.5rem  ')); // traditional old school way (not recommended)
...
console.log(Math.max(5, 18, '23', 11, 2)); // works with type coersion
...
// Rounding integers
console.log('Math.round', Math.round(23.3));
console.log('Math.round', Math.round(23.9));

console.log('Math.ceil', Math.ceil(23.3));
console.log('Math.ceil', Math.ceil(23.9));

console.log('Math.floor', Math.floor(23.3));
console.log('Math.floor', Math.floor('23.9')); // works with type coersion
...
// Challenge: print clock with just hours minutes and seconds
